...
public class PedidoView extends javax.swing.JDialog {
    ...
    public PedidoView(java.awt.Frame parent, boolean modal, String cli, List<PedidoItens> listaItens ) {
        super(parent, modal);
        initComponents();
        requestFocus();
        subtotal = 0;
...
//       
    ...
    public static void formPesquisaProduto(){
        ...
        if (pProd == null)
           pProd = new PesquisaProdutoView(new java.awt.Frame(), true, "BALCAO");
        pProd.setTitle("Pesquisa Produto");
        pProd.setLocationRelativeTo(null); // centraliza a tela
        pProd.setVisible(true);
